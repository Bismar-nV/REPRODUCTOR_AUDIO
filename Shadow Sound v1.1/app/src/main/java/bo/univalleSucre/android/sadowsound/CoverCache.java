...
public class CoverCache {
	...
	/**
	 * Use sadowsound musics cover load mechanism
	 */
	public static final int COVER_MODE_VANILLA = 0x2;
	/**
	 * Use sadowsound musics SHADOW cover load mechanism
	 */
	public static final int COVER_MODE_SHADOW = 0x4;
	/**
	 * Use sadowsound musics INLINE cover load mechanism
	 */
		...
		public Bitmap createBitmap(Context ctx, Song song, long maxPxCount) {
			...
			try {
				...
				if (inputStream == null && (CoverCache.mCoverLoadMode & CoverCache.COVER_MODE_SHADOW) != 0) {
					final String shadowBase = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MUSIC).getPath() + "/.sadowsound";
