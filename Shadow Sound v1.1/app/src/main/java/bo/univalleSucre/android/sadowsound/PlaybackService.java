			 ...
			 , AudioManager.OnAudioFocusChangeListener
{
	...
	*/
	 ...
	 */
	public static final String ACTION_TOGGLE_PLAYBACK = "ch.univalleSucre.android.sadowsound.action.TOGGLE_PLAYBACK";
	/**
	 * Action for startService: start playback if paused.
	 */
	public static final String ACTION_PLAY = "ch.univalleSucre.android.sadowsound.action.PLAY";
	/**
	 * Action for startService: pause playback if playing.
	 */
	public static final String ACTION_PAUSE = "ch.univalleSucre.android.sadowsound.action.PAUSE";
	/**
	 * Action for startService: toggle playback on/off.
	 *
	 ...
	 * instead.
	 */
	public static final String ACTION_TOGGLE_PLAYBACK_DELAYED = "ch.univalleSucre.android.sadowsound.action.TOGGLE_PLAYBACK_DELAYED";
	/**
	 * Action for startService: advance to the next song.
	 */
	public static final String ACTION_NEXT_SONG = "ch.univalleSucre.android.sadowsound.action.NEXT_SONG";
	/**
	 * Action for startService: advance to the next song.
	 *
	 ...
	 * instead.
	 */
	public static final String ACTION_NEXT_SONG_DELAYED = "ch.univalleSucre.android.sadowsound.action.NEXT_SONG_DELAYED";
	/**
	 * Action for startService: advance to the next song.
	 *
	 ...
	 * when this is called.
	 */
	public static final String ACTION_NEXT_SONG_AUTOPLAY = "ch.univalleSucre.android.sadowsound.action.NEXT_SONG_AUTOPLAY";
	/**
	 * Action for startService: go back to the previous song.
	 */
	public static final String ACTION_PREVIOUS_SONG = "ch.univalleSucre.android.sadowsound.action.PREVIOUS_SONG";
	/**
	 * Action for startService: go back to the previous song.
	 *
	 ...
	 * when this is called.
	 */
	public static final String ACTION_PREVIOUS_SONG_AUTOPLAY = "ch.univalleSucre.android.sadowsound.action.PREVIOUS_SONG_AUTOPLAY";
	/**
	 * Flushes the queue, switches to random mode and starts playing.
	 */
	public static final String ACTION_RANDOM_MIX_AUTOPLAY = "ch.univalleSucre.android.sadowsound.action.RANDOM_MIX_AUTOPLAY";
	/**
	 * Flushes the queue and plays everything of the passed type/id combination.
	 */
	public static final String ACTION_FROM_TYPE_ID_AUTOPLAY = "ch.univalleSucre.android.sadowsound.action.FROM_TYPE_ID_AUTOPLAY";
	/**
	 * Change the shuffle mode.
	 */
	public static final String ACTION_CYCLE_SHUFFLE = "ch.univalleSucre.android.sadowsound.CYCLE_SHUFFLE";
	/**
	 * Change the repeat mode.
	 */
	public static final String ACTION_CYCLE_REPEAT = "ch.univalleSucre.android.sadowsound.CYCLE_REPEAT";
	/**
